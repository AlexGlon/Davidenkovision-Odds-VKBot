...
CURRENT_BALANCE = "Ваш текущий баланс: {value}"
...
NO_BALANCE_TO_SHOW = (
    "У вас нет балансов! Такое возможно, только если вы воспользовались ботом впервые "
    "и при этом никакие ставки не открыты."
)
...
WELCOME_MESSAGE = (
    "Добро пожаловать в бота-букмекера!\n"
    'Введите команду "ставка", чтобы сделать ставку.\n'
    'Введите команду "ставки", чтобы увидеть текущие коэффициенты.\n'
    'Введите команду "мои ставки", чтобы увидеть свои текущие ставки на открытые в данный момент категории.\n'
    'Введите команду "баланс", чтобы увидеть свой текущий баланс фишек.\n'
    'Введите команду "история ставок", чтобы увидеть свою полную историю ставок.\n'
    'Введите команду "отменить ставку", чтобы отменить одну из ставок на открытую в данный момент категорию.\n'
    'Введите команду "заявки", чтобы увидеть список заявок, принимающих участие в определённом этапе конкурса.\n'
    'Введите команду "старт", чтобы увидеть это сообщение снова.\n\n'
    "На старте у вас есть 100 фишек -- пользуйтесь ими с умом! "
)
